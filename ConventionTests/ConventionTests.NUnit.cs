...
namespace ConventionTests
{
    ...
    public class ConventionData
    {
        ...
        /// <summary>
        ///   List of types to apply the convention to. Mutually exclusive with <see cref="Assemblies" /> property. If <paramref
        ///    name="sourceTypes" /> is specified <see cref="Assemblies" /> property will be ignored.
        /// </summary>
